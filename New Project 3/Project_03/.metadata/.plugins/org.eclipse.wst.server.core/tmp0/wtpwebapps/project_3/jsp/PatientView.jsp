...
<body class="hm">
	...
	<div>
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" name="name"  onkeypress="return validateInput(event)" placeholder="Enter Name" value="<%=DataUtility.getStringData(dto.getName())%>">
      </div>
    </div>
...
<span class="pl-sm-5"><b>Mobile</b>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" id="datepicker2" maxlength="10" name="mobile" class="form-control" oninput="validateMobileNo(event)" placeholder="mobile"  value="<%=DataUtility.getStringData(dto.getMobile()) %>">
      </div>
    </div>	
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("mobile", request)%></font></br>
	 ...
	 <span class="pl-sm-5"><b> decease</b>
		<span style="color: red;">*</span></span> </br>
		<div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
        ...
        <input type="text" class="form-control" name="decease"  onkeypress="return validateInput(event)" placeholder="Enter decease" value="<%=DataUtility.getStringData(dto.getDecease())%>">
      </div>
    </div>
