...
.grad{
background-image: linear-gradient( 107.5deg,  rgba(208,222,170,1) 11.7%, rgba(191,226,224,1) 70.5% );
}

.p4 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/2128286 forsetsun.jpg');
	background-size: 100%;
	padding-top: 6%;
						...
						<div class="card-body">
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									value="<%=UserRegistrationCtl.OP_SAVE%> <%-- succes = green botton --%>"> <input
									type="submit" name="operation" class="btn btn-secondary btn-md"
									style="font-size: 17px"
									value="<%=UserRegistrationCtl.OP_RESET%>">  <!-- secondery = grey botton -->
							</div>
						</div>
