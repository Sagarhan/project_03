				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.INVENTORY_CTL%>"><i
							class="fas fa-clock"></i>Add Inventory</a> <a class="dropdown-item"
							href="<%=ORSView.INVENTORY_LIST_CTL%>"><i
							class="far fa-clock"></i>Inventory List</a>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.PATIENT_CTL%>"><i
							...
							class="far fa-clock"></i>Patient List</a>
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.ORDER_CTL%>"><i
							...
							class="far fa-clock"></i>Order List</a>
