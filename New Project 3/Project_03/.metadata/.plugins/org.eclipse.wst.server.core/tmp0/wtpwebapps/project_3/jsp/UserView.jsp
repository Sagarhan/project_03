...
<body class="hm">
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon grad">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-light">Update User</h3>
							<%
								} else {
							%>
							<h3 class="text-center default-text text-dark">Add User</h3>
							<%
								}
							%>
							<!--Body-->
	...
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("role", request)%></font></br>	
	 ...
	 <span class="pl-sm-5"><b>FirstName</b><span style="color:red;">*</span></span></br>
	<div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text"><i class="fa fa-user grey-text" style="font-size: 1rem;"></i> </div>
        </div>
        <%=HTMLUtility.getList("firstName", String.valueOf(dto.getFirstName()), ulist)%>
      </div>
    </div>							
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("firstName", request)%></font></br>							
