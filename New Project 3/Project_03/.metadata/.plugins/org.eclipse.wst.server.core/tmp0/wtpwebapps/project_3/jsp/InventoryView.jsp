							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" id="datepicker2" name="lastUpdatedDate"
											class="form-control" placeholder="lastUpdatedDate "
											readonly="readonly"
											value="<%=DataUtility.getDateString(dto.getLastUpatedDate())%>">
									</div>
								</div>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" maxlength="25" name="quantity"
					...
					: DataUtility.getStringData(dto.getQuantity())%>">
									...
									<div class="col-sm-12">
										<div class="input-group">
											...
											<%
												String htmlList = HTMLUtility.getList("product", dto.getProduct(), map1);
											%>
