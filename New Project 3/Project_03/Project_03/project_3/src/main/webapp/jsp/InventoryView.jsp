				...
				<div class="col-md-4 mb-4">
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									...
									<font color="red" class="pl-sm-5" id="suppliernameError">
										<%=ServletUtility.getErrorMessage("suppliername", request)%></font></br>
								</div>
								...
								<span class="pl-sm-5"><b></b> <span style="color: red;">*</span></span>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name=quantity
											placeholder=" Enter quantity" oninput="numberLength(this)"
					...
					: DataUtility.getStringData(dto.getQuantity())%>"
										...
										<span id="quantity-validation-message"
											style="display: none; color: red;">Only number are allow
											allowed </span> <font color="red" class="pl-sm-5" id="quantityError"></font>
									</div>
								</div>
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										class="btn btn-success btn-md" style="font-size: 17px"
										value="<%=InventoryCtl.OP_SAVE%>"> <input
										type="submit" name="operation" class="btn btn-warning btn-md"
