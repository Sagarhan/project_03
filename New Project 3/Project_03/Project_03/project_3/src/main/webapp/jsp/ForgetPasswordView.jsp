...
.css{
background-image: radial-gradient( circle 266px at 12% 29.3%,  rgba(58,219,154,0.93) 2%, rgba(153,228,208,1) 38.6%, rgba(142,246,219,0.82) 73.9%, rgba(253,255,238,1) 100.7%,   rgba(58,219,154,0.93) 2% );
}
.p4{
background-image: url('<%=ORSView.APP_CONTEXT%>/img/96689 jungle.jpg');
	background-size: 100%;
		padding-top: 8%;
	...
	<div>
		...
		<form action="<%=ORSView.FORGET_PASSWORD_CTL%>" method="post">
			...
			<div class="row pt-5">
				...
				<div class="col-md-4">
					<div class="card input-group-addon css">
						<div class="card-body">
							<h3 class="text-center default-text text-dark">Forget Your Password?</h3>
							<p class="text-center default-text text-dark" style="font-size:11px;"> Submit your Email Address and we will Send You password</p>
