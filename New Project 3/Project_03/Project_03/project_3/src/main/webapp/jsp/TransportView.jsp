...
.grad {
	background-image: radial-gradient(circle farthest-corner at 5.6% 54.5%, rgba(159, 188, 198
		, 1) 83.6%, rgba(47, 71, 79, 1) 0%, rgba(159, 188, 198, 1) 83.6%,
		rgba(47, 71, 79, 1) 0%);
}

.hm {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/34343.jpg');
	background-size: 100%;
	padding-top: 8%;
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon grad">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-light">Update
								Transport</h3>
							<%
								} else {
							%>
							<h3 class="text-center default-text text-dark">Add Transport</h3>
							<%
								}
							%>
							<!--Body-->
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>Descriptione</b> <span
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="defaultForm-email"
											maxlength="10" name="cost" placeholder="Enter Cost"
											value="<%=DataUtility.getIntt(dto.getCost())%>">
									</div>
								</div>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										String htmlList = HTMLUtility.getList("mode", dto.getMode(), map1);
									%>
										<%=htmlList%></div>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" id="udate" name="date" class="form-control"
											...
											value="<%=DataUtility.getDateString(dto.getTdate()) %>">
									</div>
								</div>
							...
							%>
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										...
										style="font-size: 17px" value="<%=TransportCtl.OP_CANCEL%>">
							...
							%>
								<div class="text-center">
									...
									<input type="submit" name="operation"
										class="btn btn-success btn-md" style="font-size: 17px"
										value="<%=TransportCtl.OP_SAVE%>"> <input
										type="submit" name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=TransportCtl.OP_RESET%>">
								</div>
