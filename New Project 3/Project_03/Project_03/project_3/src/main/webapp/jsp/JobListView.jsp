...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.JOB_LIST_CTL%>" method="post">
			...
			<%
				HashMap map = (HashMap) request.getAttribute("job");
			%>
			...
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">Job List</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					 ...
					 <input type="text" class="form-control" name=title
						...
						color="red" class="pl-sm-5" id="titleError"> <%=ServletUtility.getErrorMessage("title", request)%></font></br>
				</div>
				<div class="col-sm-2">
				...
				<div class="col-sm-2">
					 ...
					 <input type="text" class="form-control" name=experience
						...
						oninput="handleLetterInput(this, 'experienceError', 50)"
						onblur="validateLetterInput(this, 'experienceError', 50)"
						value="<%=DataUtility.getStringData(dto.getExperience())%>"> <font
						color="red" class="pl-sm-5" id="experienceError"> <%=ServletUtility.getErrorMessage("experience", request)%></font></br>
				 ...
				 <div class="col-sm-2">
					<input type="text" name="opningjob"
						placeholder="Enter openingjob" id="datepicker"
						class="form-control"
						value="<%=ServletUtility.getParameter("opningjob", request)%>">
		...
		<table class="table table-bordered table-dark table-hover">
			<thead>
				<tr style="background-color: purple;">
					...
					<th width="15%" class="text">OpeningJob</th>
			...
			<tbody>
				<tr>
					...
					<td class="text"><%=dto.getOpeningjob()%></td>
	...
	<div class="row">
		...
		<div style="padding-left: 48%;">
			<input type="submit" name="operation" class="btn btn-primary btn-md"
				style="font-size: 17px" value="<%=JobListCtl.OP_BACK%>">
		</div>
