		...
		<form class="pb-5" action="<%=ORSView.INVENTORY_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<input type="text" class="form-control" name=suppliername
						...
						value="<%=DataUtility.getStringData(dto.getSuppliername())%>"> <font
						color="red" class="pl-sm-5" id="suppliernameError"> <%=ServletUtility.getErrorMessage("suppliername", request)%></font></br>
				</div>
				<div class="col-sm-2">


					<%
						String htmlList = HTMLUtility.getList("product1", String.valueOf(dto.getProduct()), map1);
					%>

					<%=htmlList%>

					<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("product1", request)%></font>
				</div>
			...
			<%-- 	<div class="col-sm-2">
					<input type="text" name="dob"
						placeholder="Enter dob" id="datepicker"
						class="form-control"
		...
		<table class="table table-bordered table-dark table-hover">
			...
			<tbody>
				<tr>
					...
					<td class="text"><%=dto.getLastupdateddate()%></td>
